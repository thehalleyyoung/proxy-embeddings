"""
image_steer.py plus ONE new mechanism: gap-driven perceptual axis expansion.
...
def run(objective: str, target: int = TARGET, tag: str = "steer3"):
...
if __name__ == "__main__":
    ...
    run(obj, int(sys.argv[2]) if len(sys.argv) > 2 else TARGET,
        sys.argv[3] if len(sys.argv) > 3 else "steer3")
