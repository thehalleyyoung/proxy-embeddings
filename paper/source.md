...
| asked | scored | programs: per call / of answers | SQL: per call / of answers |
|---|---|---|---|
| exactly | exactly | 90.7% / 95.9% [91.8, 99.2] | 55.6% / 87.7% [78.9, 94.7] |
| **as a band** | **on the band** | **97.7% / 98.4%** [96.1, 100.0] | **68.9% / 91.2%** [83.8, 97.1] |
| as a band | exactly | 36.4% / 36.7% [28.1, 45.3] | 21.1% / 27.9% [17.6, 38.2] |
| exactly | on the band | 92.2% / 97.5% [94.3, 100.0] | 58.9% / 93.0% [86.0, 98.2] |

*Completion spreads after equalizing: 4.7 points on programs, 12.2 on SQL, both
under the 15-point threshold.*

The tolerance benefit is **+7.0 and +13.3 points per call issued** on the two
decoders, and **+2.5 and +3.5 points among generations that answered**, with
overlapping intervals on both of the second pair. So a band helps, modestly, and
we cannot separate how much of even that is a residual return-rate effect from
how much is accuracy. The honest statement is that it is worth roughly seven to
thirteen points of yield and is not established as making the artifact more
likely to be right.
